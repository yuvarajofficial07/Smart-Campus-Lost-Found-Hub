  ...
  head: () => ({
    meta: [
      ...
      { title: "Campus Lost & Found Hub" },
      {
        name: "description",
        content:
          "A simple board for our college to post lost and found items and reach each other fast.",
      },
    ...
    <header className="border-b border-border bg-card/80 backdrop-blur">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
        ...
        <nav className="flex items-center gap-2 text-sm">
          <Link
            to="/"
            className="rounded-lg px-3 py-2 font-medium text-muted-foreground hover:text-foreground"
    ...
    <QueryClientProvider client={queryClient}>
      <div className="flex min-h-screen flex-col">
        ...
        <footer className="mt-auto border-t border-border py-6 text-center text-xs text-muted-foreground">
          Built for our campus. Please return what you find.
        </footer>
      </div>
